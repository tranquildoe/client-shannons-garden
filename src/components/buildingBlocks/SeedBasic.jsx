  ...
  return (
    <>
      {mySeeds.map((oneSeed, i) => (
        <div
          className="topTwoRows"
          key={i}
          onChange={e => handleChange(e, oneSeed)}
            ...
            <div>
              ...
              <div className="checkboxes">
                ...
                <input
                  ...
                  id="forTrade"
                  name="forTrade"
                  defaultChecked={oneSeed.forTrade}
                />
                ...
                <input
                  type="checkbox"
                  id="isOpenPollinated"
                  name="isOpenPollinated"
                  defaultChecked={oneSeed.isOpenPollinated}
                />
                ...
                <input
                  ...
                  id="isHeirloom"
                  name="isHeirloom"
                  defaultChecked={oneSeed.isHeirloom}
                />
                ...
                <input
                  ...
                  id="isHybrid"
                  name="isHybrid"
                  defaultChecked={oneSeed.isHybrid}
                />
                ...
                <input
                  ...
                  id="isMedicinal"
                  name="isMedicinal"
                  defaultChecked={oneSeed.isMedicinal}
                />
                ...
                <input
                  ...
                  id="isEdible"
                  name="isEdible"
                  defaultChecked={oneSeed.isEdible}
                />
              </div>
            </div>
          </div>
